...
class CarBrandSwagger
{
     /**
     * @OA\Get(
     *     summary="Car licensors",
     *     path="/api/car-settings/brands",
     *     tags={"CarSettings/Brands"},
     *     security={{"bearerAuth":{}}},
     * 
     * @OA\Parameter(
     *     name="limit",
     ...
     *     path="/api/car-settings/brands/{brand_id}/edit",
     *     operationId="/api/car-settings/brands/{brand_id}/edit",
     *     tags={"CarSettings/Brands"},
     *     security={{"bearerAuth":{}}},
     *
     *   @OA\Parameter(
    ...
    public function edit(){}
      ...
      /**
     * @OA\Patch(
     ** path="/api/car-settings/brands/{brand_id}",
     *   tags={"CarSettings/Brands"},
